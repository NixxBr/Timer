...
//			|		|
//			|	6.	|	Listen for shots - 
//			|		|		- microphone Circuit  - DONE
//			|		|		- sensitivity
//
//			|	7.|  Sleep 
//      |   |    -  Wakeup
//      |   |    -  Sleep delay (time before shutdown)
//      |   |     
//      | 8.|   Noise switch off & on  
//      |   |   -  switch on on button down ( timer triggers on release)  
//      |   |     
//      | 9.|  Random delay start      
//      |   |  -  set menu option   
// ================================================================================================
...
// pin 10 - Serial clock out (SCLK) was 7
// pin 2 - Serial data out (DIN)mosi  wad 6
// pin 3 - Data/Command select (D/C) was 5
// pin 5 - LCD chip select (CS) was 4
// pin 4 - LCD reset (RST) was 3
Adafruit_PCD8544 display = Adafruit_PCD8544(10, 2, 3, 5, 4);
//==================================================
int shotCntr = 0;
int ReviewShot = 0;
int ledpin = 13;
...
void setup()
{
  ...
  pinMode(noisePwrPin, OUTPUT);
  // for now power always ==========
  digitalWrite(noisePwrPin, HIGH);
